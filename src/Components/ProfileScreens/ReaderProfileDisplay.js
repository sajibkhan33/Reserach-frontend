...
import styles from './ReaderProfileDisplay.module.css';
import { useCookies } from 'react-cookie';
import Header from '../HomeScreen/Header';
import Footer from '../HomeScreen/Footer';

const ReaderProfileDisplay = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        const response = await fetch('http://127.0.0.1:8000/auth/reader-profiles/', {
          method: 'GET',
          headers: {
...
export default ReaderProfileDisplay;
